...
@WebMvcTest
public class EmployeeControllerTests_UnitTest_WebMvcTest {
    ...
    public void givenInvalidEmployeeId_whenGetEmployeeById_thenReturnEmpty() throws Exception{
        ...
        given(employeeService.getEmployeeById(employeeId)).willThrow(new EmployeeNotFoundException("Employee Not Found"));
